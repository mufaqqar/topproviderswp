        ...
        <div class="py-7 border-t border-gray-700">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    ...
                    <a href="https://www.facebook.com/topproviders" target="_blank" rel="noopener noreferrer" class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                    ...
                    <a href="https://www.youtube.com/@top-providers" target="_blank" rel="noopener noreferrer" class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
